    ...
    public class MappingTask : ICloakTask
    {
        ...
        private static void ProcessAssembly(ICloakContext context, AssemblyDefinition definition)
        {
            ...
            foreach (ModuleDefinition moduleDefinition in definition.Modules)
            {
                ...
                {
                	//nameManager.ResetNonTypeCounters();//reset counters for methods,fields, props, cos they
                	//could be the same in different classes
                    ...
                    if (typeMapping == null)
                    {
                        ...
                        if (obfuscateAll)
                            typeMapping = assemblyMapping.AddType(typeDefinition,
                                                                  nameManager.GenerateName(NamingType.Type,typeDefinition));
                        else
                    ...
                    foreach (MethodDefinition methodDefinition in typeDefinition.Methods)
                    {
                            ...
                            if (methodDefinition.IsVirtual)
                            {
                                ...
                                if (baseType != null)
                                {
                                    ...
                                    if (baseTypeMapping != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            string obfuscatedName = nameManager.GenerateName(NamingType.Method,methodDefinition);
                                    ...
                                    else
                                    {
                                        ...
                                        baseTypeMapping = assemblyMapping.AddType(baseType,
                                                                  nameManager.GenerateName(NamingType.Type,baseType));
                                        string obfuscatedName = nameManager.GenerateName(NamingType.Method,methodDefinition);
                                        baseTypeMapping.AddMethodMapping(methodDefinition, obfuscatedName);
                                ...
                                else
                                {
                                    ...
                                    typeMapping.AddMethodMapping(methodDefinition,
                                                         nameManager.GenerateName(NamingType.Method,methodDefinition));
                                }
                            }
                            else //Add normally
                                typeMapping.AddMethodMapping(methodDefinition,
                        ...
                        else if (methodDefinition.IsPrivate)//if not obfuscate all, we obfuscate all privates anyway
                            typeMapping.AddMethodMapping(methodDefinition, nameManager.GenerateName(NamingType.Method,methodDefinition));
                    }
                    ...
                    foreach (PropertyDefinition propertyDefinition in typeDefinition.Properties)
                    {
                                ...
                                (propertyDefinition.SetMethod != null && propertyDefinition.SetMethod.IsVirtual))
                            {
                                ...
                                if (baseType != null)
                                {
                                    ...
                                    if (baseTypeMapping != null)
                                    {
                                        ...
                                        else
                                        {
                                            //That's strange... we shouldn't get into here - but if we ever do then
                                            //we'll add the type mapping into both
                                            string obfuscatedName = nameManager.GenerateName(NamingType.Property,propertyDefinition);
                                ...
                                else
                                {
                                    ...
                                    typeMapping.AddPropertyMapping(propertyDefinition,
                                                         nameManager.GenerateName(NamingType.Property,propertyDefinition));
                                }
                            }
                            else
                                typeMapping.AddPropertyMapping(propertyDefinition,
                        ...
                        else if (propertyDefinition.GetMethod != null && propertyDefinition.SetMethod != null)
                        {
                            ...
                            if (propertyDefinition.GetMethod.IsPrivate && propertyDefinition.SetMethod.IsPrivate)
                                typeMapping.AddPropertyMapping(propertyDefinition, nameManager.GenerateName(NamingType.Property,propertyDefinition));
                        }
                    ...
                    foreach (FieldDefinition fieldDefinition in typeDefinition.Fields)
                    {
                        ...
                        if (obfuscateAll)
                            typeMapping.AddFieldMapping(fieldDefinition, nameManager.GenerateName(NamingType.Field,fieldDefinition));
